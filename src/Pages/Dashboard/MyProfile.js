                ...
                <div className='mt-6'>
                    <form>
                        <div class="form-control w-full max-w-xs mb-5">
                            ...
                            <input type="text" placeholder={user?.displayName} class="input input-bordered w-full max-w-xs" />
                        </div>
                        <div class="form-control w-full max-w-xs mb-5">
                            <p className='text-left mb-2'>Email</p>
                            <input type="email" placeholder={user?.email} class="input input-bordered w-full max-w-xs" />
                        </div>
                        <div class="form-control w-full max-w-xs mb-5">
